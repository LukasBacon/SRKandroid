...
public class NothingSelectedSelectBoxAdapter implements SpinnerAdapter, ListAdapter {
    ...
    public NothingSelectedSelectBoxAdapter(SpinnerAdapter spinnerAdapter,
